...
export default async function handler(req, res) {
  ...
  if (req.query?.debug === "1") {
    const tests = [
      ...
      // ── 명목 GDP 후보 (가계부채/GDP 비율 계산용)
      ["GDP명목_200Y001_10111", "200Y001", "10111", "Q", "2022Q1", "2024Q4"],  // 명목GDP 전기비%
      ["GDP명목_200Y001_20111", "200Y001", "20111", "Q", "2022Q1", "2024Q4"],  // 명목GDP 잔액(십억원)?
      ["GDP명목_200Y002_10111", "200Y002", "10111", "Q", "2022Q1", "2024Q4"],  // 명목GDP 계열2
      ["GDP명목_200Y002_20111", "200Y002", "20111", "Q", "2022Q1", "2024Q4"],
      ["GDP명목_200Y004_10111", "200Y004", "10111", "Q", "2022Q1", "2024Q4"],  // 지출GDP
      ["GDP명목_200Y004_AA",    "200Y004", "AA",    "Q", "2022Q1", "2024Q4"],
      // ── 가계신용 단위 확인 (현재 1000000 itemCode)
      ["가계신용_151Y001",      "151Y001", "1000000","Q","2022Q1", "2024Q4"],
    ];
    const results = {};
