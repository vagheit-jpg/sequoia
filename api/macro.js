...
export default async function handler(req, res) {
  ...
  if (req.query?.debug === "1") {
    const tests = [
      ...
      // ── 명목 GDP 전기비/전년비 후보 (체인 계산용)
      ["GDP명목전기비_10112",  "200Y102", "10112", "Q", "2020Q1", "2024Q4"],  // 명목 GDP 전기비%
      ["GDP명목전년비_20112",  "200Y102", "20112", "Q", "2020Q1", "2024Q4"],  // 명목 GDP 전년동기비%
      ["GDP명목잔액_10211",    "200Y102", "10211", "Q", "2020Q1", "2024Q4"],  // 명목 GDP 잔액(십억원)?
      ["GDP명목잔액_20211",    "200Y102", "20211", "Q", "2020Q1", "2024Q4"],
      // 200Y001 계열 (명목 GDP 별도 통계)
      ["GDP_200Y001_10111",   "200Y001", "10111", "Q", "2020Q1", "2024Q4"],
      ["GDP_200Y001_AA",      "200Y001", "AA",    "Q", "2020Q1", "2024Q4"],
      // 현재 사용중인 실질 전기비 확인용
      ["GDP실질전기비_10111", "200Y102", "10111", "Q", "2022Q1", "2024Q4"],
    ];
    const results = {};
