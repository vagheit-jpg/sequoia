...
export default async function handler(req, res) {
  ...
  if (req.query?.debug === "1") {
    const tests = [
      ...
      // ── FVI(금융취약성지수) 후보 코드 전수 테스트
      // 602Y001 계열
      ["FVI_602Y001_AA",  "602Y001", "AA", "Q", "2020Q1", "2024Q4"],
      ["FVI_602Y001_1",   "602Y001", "1",  "Q", "2020Q1", "2024Q4"],
      ["FVI_602Y001_10",  "602Y001", "10", "Q", "2020Q1", "2024Q4"],
      ["FVI_602Y001_A",   "602Y001", "A",  "Q", "2020Q1", "2024Q4"],
      // 602Y002 계열 (금융불균형지수)
      ["FVI_602Y002_AA",  "602Y002", "AA", "Q", "2020Q1", "2024Q4"],
      ["FVI_602Y002_1",   "602Y002", "1",  "Q", "2020Q1", "2024Q4"],
      // 600Y003 계열 (금융안정지수 FSI)
      ["FSI_600Y003_AA",  "600Y003", "AA", "M", "202001",  "202412"],
      ["FSI_600Y003_1",   "600Y003", "1",  "M", "202001",  "202412"],
      ["FSI_600Y003_10",  "600Y003", "10", "M", "202001",  "202412"],
      // 601Y002 계열 (처분가능소득대비 가계부채)
      ["LTI_601Y002_AA",  "601Y002", "AA", "Q", "2020Q1", "2024Q4"],
      ["LTI_601Y002_1",   "601Y002", "1",  "Q", "2020Q1", "2024Q4"],
      // 601Y001 계열
      ["LTI_601Y001_AA",  "601Y001", "AA", "Q", "2020Q1", "2024Q4"],
      ["LTI_601Y001_1",   "601Y001", "1",  "Q", "2020Q1", "2024Q4"],
    ];
    const results = {};
