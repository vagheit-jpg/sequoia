    ...
    try {
      ...
      if (MARKET==="ALL"||MARKET==="GLOBAL") {
        ...
        await upsertSnapshot({
          ...
          key_indicators:{ sefcon_score:gs, sefcon_level:gl,
            korea_sefcon_score:kr.sefcon_score, us_sefcon_score:us.sefcon_score,
            fred_t10y2y:s.t10y2y, fred_vix:s.vix, fred_hy:s.baml, dxy:s.dxy,
            krw_usd:s.krw_usd, kospi_last:s.kospi_last, sp500_last:s.sp500_last,
            nq_trend_12m:s.nq_trend12m, liquidity_pressure:us.physics.liquidityPressure,
